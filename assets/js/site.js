...
(function () {
  ...
  function initRouteScene() {
    ...
    var captions = [
      { title: 'Європа → Україна', text: 'Прокрутіть — фура пройде ключові точки коридору.' },
      { title: 'Кордон і митниця', text: 'Документи готові — перетин без зайвих зупинок.' },
      { title: 'Транзит Україною', text: 'Моніторинг рейсу на маршруті до точки видачі.' },
      { title: 'Доставка в Київ', text: 'Вантаж на місці. Рейс закрито.' }
    ];
