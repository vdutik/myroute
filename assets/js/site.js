...
(function () {
  ...
  function initRouteScene() {
    ...
    var captions = [
      { title: 'Транзит Україною', text: 'Завантаження у Варшаві — далі кордон, митниця у Львові та розвантаження в Києві.' },
      { title: 'Пункт переходу', text: 'Кордон попереду. Документи готові — перетин без зайвих зупинок.' },
      { title: 'Митниця у Львові', text: 'Оформлення на митниці. Моніторинг рейсу до точки видачі.' },
      { title: 'Розвантаження в Києві', text: 'Вантаж на місці. Імпортний рейс завершено.' }
    ];
